...
- server/database/database.go:34: @todo(nick-ng): update snapshot file size
- server/database/database.go:147: @todo(nick-ng): convert log to snapshot
- server/database/database.go:278: @todo(nick-ng): make sure owner doesn't have a colon (doesn't matter?)
